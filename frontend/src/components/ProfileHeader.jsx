			...
			case "connected":
				return (
					<div className='flex gap-2 justify-center'>
						...
						<button
							className={`${baseClass} bg-red-500 hover:bg-red-600 `} style={{borderRadius: "20px"}}
			...
			default:
				return (
					<button
						...
						className='bg-blue-500 hover:bg-blue-800 text-white py-2 px-4 transition duration-300 flex items-center justify-center' style={{borderRadius: "20px"}}
					>
				...
				{isOwnProfile ? (
					isEditing ? (
						...
						<button
							...
							className='btn w-full bg-primary text-white py-2 px-4 !hover:bg-blue-800
							 transition duration-300'
						>
							Editar Perfil
						</button>
